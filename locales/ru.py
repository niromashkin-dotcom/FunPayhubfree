...
💬 <b><i>Telegram чат:</i></b> @funpay_hub
...
update_lasted = "✅ У тебя стоит последняя версия FunPayHub {}"
...
🛠️ Создать своего бота: github.com/sidor0912/FunPayHub
💰 Донат: @sidor_donate
...
# Новые команды
cmd_market = "📊 Ситуация на рынке"
cmd_balance = "💰 Баланс"
cmd_report = "🖥️ Отчет системы"
cmd_create_lot = "➕ Создать лот"
cmd_remove_all_lots = "🗑️ Снять все лоты"
cmd_auto_create_lots = "🤖 Автосоздание лотов"
cmd_simulate = "🎮 Симуляция"
cmd_start_app = "🚀 Старт приложения"
